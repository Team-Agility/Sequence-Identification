...
class EditPractical extends React.Component {
  ...
  getCurrentQuestionList = async () => {
    try {
      ...
      notification.error({
        message: "Error!",
        description: e.message ? e.message : "Error retrieving overview",
      });
    }
  };
          ...
          <Card title={"Select Question Level"}>
            <Row>
              <Col>
                ...
                >
                  {this.state.currentCourseList
                    ? this.state.currentCourseList.levels.map((course) => (
              ...
              <Form
                ...
                fields={[
                  ...
                  },
                  {
                    name: "level",
                    value: this.state.selectedQuestion
                      ? this.state.selectedQuestion.level
                      : "",
                  },
                  {
                    name: "category",
                    value: this.state.selectedQuestion
                      ? this.state.selectedQuestion.category
                      : "",
                  },
                  {
                    name: "description",
                  ...
                  },
                  {
                    name: "difficulty",
                    value: this.state.selectedQuestion
                      ? this.state.selectedQuestion.difficulty
                      : "",
                  },
                  {
                    name: "pointsAllocated",
                    value: this.state.selectedQuestion
                      ? this.state.selectedQuestion.pointsAllocated
                      : "",
                  },
                  {
                    name: "inputs",
                  ...
                  },
                  {
                    name: "testcases",
                    value: this.state.selectedQuestion
                      ? this.state.selectedQuestion.testcases
                      : "",
                  },
                ]}
              >
                      ...
                      {fields.map(({ key, name, fieldKey, ...restField }) => (
                        <Form.Item label={"Test case"}>
                          ...
                          <Form.Item
                            ...
                            rules={[
                              { required: true, message: "Missing inputs" },
                            ]}
                          >
                          ...
                          <Form.Item
                            ...
                            rules={[
                              { required: true, message: "Missing outputs" },
                            ]}
                          >
