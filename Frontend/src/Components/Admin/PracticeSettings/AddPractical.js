          ...
          <Spin spinning={this.state.dataLoading}>
            <Form
              ...
              fields={[
                {
                  name: "title",
                  value: this.state.newPractical
                    ? this.state.newPractical.title
                    : "",
                },
                {
                  name: "level",
                  value: this.state.newPractical
                    ? this.state.newPractical.level
                    : "",
                },
                {
                  name: "category",
                  value: this.state.newPractical
                    ? this.state.newPractical.category
                    : "",
                },
                {
                  name: "description",
                  value: this.state.newPractical
                    ? this.state.newPractical.description
                    : "",
                },
                {
                  name: "difficulty",
                  value: this.state.newPractical
                    ? this.state.newPractical.difficulty
                    : "",
                },
                {
                  name: "pointsAllocated",
                  value: this.state.newPractical
                    ? this.state.newPractical.pointsAllocated
                    : "",
                },
                {
                  name: "inputs",
                  value: this.state.newPractical
                    ? this.state.newPractical.inputs
                    : "",
                },
                {
                  name: "outputs",
                  value: this.state.newPractical
                    ? this.state.newPractical.outputs
                    : "",
                },
                {
                  name: "testcases",
                  value: this.state.newPractical
                    ? this.state.newPractical.testcases
                    : "",
                },
              ]}
            >
