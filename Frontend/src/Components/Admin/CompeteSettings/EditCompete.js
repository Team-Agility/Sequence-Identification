...
import {
  getCompeteQuestionById,
  getQuestionByCategory,
} from "../../../Services/CompeteService";
...
class EditCompeteQuestion extends React.Component {
  ...
  onDelete = async () => {
    ...
    try {
      ...
      notification.error({
        message: "Error!",
        description: e.message ? e.message : "Error deleting!",
      });
    }
    this.setState({
      dataLoading: false,
  ...
  onFinish = async (data) => {
    if (
      !this.state.newPracticalTestcases ||
      this.state.newPracticalTestcases.length < 1
    ) {
      ...
      <div>
          ...
          <Card title={"Select Question Category"}>
            <Row>
              ...
              <Col offset={1}>
                ...
                >
                  {this.state.selectedQueList
                    ? this.state.selectedQueList.questions.map((question) => (
              ...
              <Col offset={1}>
                <Button
                  shape="round"
                  icon={<SearchOutlined />}
                  disabled={!this.state.selectedQuestionId}
            ...
            <Spin spinning={this.state.dataLoading}>
              <Form
                ...
                fields={[
                  {
                    name: "title",
                    value: this.state.newCompeteTitle
                      ? this.state.newCompeteTitle
                      : "",
                  },
                  {
                    name: "category",
                    value: this.state.newCompeteCategory
                      ? this.state.newCompeteCategory
                      : "",
                  },
                  {
                    name: "description",
                    value: this.state.newCompeteDescription
                      ? this.state.newCompeteDescription
                      : "",
                  },
                  {
                    name: "difficulty",
                    value: this.state.newCompeteDifficulty
                      ? this.state.newCompeteDifficulty
                      : "",
                  },
                  {
                    name: "pointsAllocated",
                    value: this.state.newCompetePointsAllocated
                      ? this.state.newCompetePointsAllocated
                      : "",
                  },
                  {
                    name: "inputs",
                    value: this.state.newCompeteInputs
                      ? this.state.newCompeteInputs
                      : "",
                  },
                  {
                    name: "outputs",
                    value: this.state.newCompeteOutputs
                      ? this.state.newCompeteOutputs
                      : "",
                  },
                  {
                    name: "testcases",
                    value: this.state.newPracticalTestcases
                      ? this.state.newPracticalTestcases
                      : "",
                  },
                ]}
              >
                ...
                <Form.Item
                  name={"testcases"}
                  label={"Test Cases"}
                  getValueProps={() => this.state.newPracticalTestcases}
                >
                  <Row gutter={16}>
                        ...
                        <Card hoverable>
                          ...
                          <Row>
                            <Col offset={12} span={6}>
                              <a onClick={() => this.editTestCase(item, index)}>
                                Edit
                              </a>
                            </Col>
                            <Col>
                              ...
                              <a>
                                <Popconfirm
                                  ...
                                  onConfirm={() =>
                                    this.deleteTestCase(item, index)
                                  }
                                >
                                  Delete
                                </Popconfirm>
        ...
        >
          <Form
            {...testLayout}
            name="test-case"
            onFinish={this.onTestCaseAdd}
            fields={[
              {
                name: "title",
                value: this.state.editableTestCase
                  ? this.state.editableTestCase.title
                  : "",
              },
              {
                name: "inputs",
                value: this.state.editableTestCase
                  ? this.state.editableTestCase.inputs
                  : "",
              },
              {
                name: "description",
                value: this.state.editableTestCase
                  ? this.state.editableTestCase.description
                  : "",
              },
              {
                name: "outputs",
                value: this.state.editableTestCase
                  ? this.state.editableTestCase.outputs
                  : "",
              },
            ]}
          >
